...
# Creator Economy Earnings Forecast

![Demo Screenshot](demo/screenshot.png)

## Overview
Forecast creator revenue variability and identify platform-side levers that improve retention.
...
- Domain: MediaTech
- Project type: `ml`
- Tags: creator, forecast, retention
